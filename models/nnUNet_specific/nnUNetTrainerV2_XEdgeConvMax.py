...
class nnUNetTrainerV2_XEdgeConvMax(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.net_num_pool_op_kernel_sizes = np.array([[2, 2, 2], [2, 2, 2],  [1,1,1]]) #[2, 2, 2], [2, 2, 2], [1, 1, 1]])
...
class nnUNetTrainerV2_XEdgeConvMax_12_drop(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        #self.net_pool_per_axis = [[4, 4, 4]]
        self.net_num_pool_op_kernel_sizes = np.array([[2, 2, 2], [2, 2, 2],  [1,1,1]]) #[2, 2, 2], [2, 2, 2], [1, 1, 1]])
        self.net_pool_per_axis = np.array([3, 3, 3])
...
class newds_156_nnUNetTrainerV2_XEdgeConvMax_12_drop(nnUNetTrainerV2_XEdgeConvMax_12_drop):
...
class newds_156_nnUNetTrainerV2_XEdgeConvMax_drop(nnUNetTrainerV2_XEdgeConvMax_12_drop):
