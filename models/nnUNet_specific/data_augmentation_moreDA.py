...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    val_transforms.append(SpatialTransform(
        patch_size_spatial, 
        patch_center_dist_from_border=None,
        do_elastic_deform=False,
        do_rotation=params.get("val_do_rotation"), 
            angle_x=params.get("val_rotation_x"), 
            angle_y=params.get("val_rotation_y"),
            angle_z=params.get("val_rotation_z"), 
            p_rot_per_axis=params.get("val_rotation_p_per_axis"),
        do_scale=False,
        border_mode_data=params.get("border_mode_data"), border_cval_data=0, order_data=order_data,
        border_mode_seg="constant", border_cval_seg=border_val_seg,
        order_seg=order_seg, 
        random_crop=False, 
        p_rot_per_sample=params.get("val_p_rot")
        ))
